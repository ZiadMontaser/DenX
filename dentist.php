...
<body>
					...
					<div role="tabpanel">
						...
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane" id="vi">
								...
								<input type="text" placeholder="date" value="yyyy-mm-dd" name="date" id="date" value="yyyy-mm-dd" class="date form-control" style="margin-bottom: 20px">
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-body">
					<div role="tabpanel">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a onclick="document.getElementById('se').style.display='none';document.getElementById('surg').style.display='none';document.getElementById('pres').style.display='none';document.getElementById('diag').style.display='none';document.getElementById('pres3').style.display='none';document.getElementById('pres4').style.display='none';document.getElementById('comp').style.display='none';document.getElementById('med_hist').style.display='none';document.getElementById('soc_hist').style.display='none';document.getElementById('vit').style.display='block';document.getElementById('exa').style.display='none';document.getElementById('tp').style.display='none';document.getElementById('ap').style.display='none';" href="#vit_tab" aria-controls="vit_tab" role="tab" data-toggle="tab">Vital Signs</a>
							</li>
							<li role="presentation"><a onclick="document.getElementById('se').style.display='none';document.getElementById('surg').style.display='none';document.getElementById('pres').style.display='none';document.getElementById('diag').style.display='none';document.getElementById('pres3').style.display='none';document.getElementById('pres4').style.display='none';document.getElementById('comp').style.display='none';document.getElementById('med_hist').style.display='none';document.getElementById('soc_hist').style.display='none';document.getElementById('vit').style.display='none';document.getElementById('exa').style.display='none';document.getElementById('tp').style.display='block';document.getElementById('ap').style.display='none';" href="#tp_tab" aria-controls="tp_tab" role="tab" data-toggle="tab">Treatment Plant</a>
							</li>
							<li role="presentation"><a onclick="document.getElementById('se').style.display='none';document.getElementById('surg').style.display='none';document.getElementById('pres').style.display='none';document.getElementById('diag').style.display='none';document.getElementById('pres3').style.display='none';document.getElementById('pres4').style.display='none';document.getElementById('comp').style.display='none';document.getElementById('med_hist').style.display='none';document.getElementById('soc_hist').style.display='none';document.getElementById('vit').style.display='none';document.getElementById('exa').style.display='block';document.getElementById('tp').style.display='none';document.getElementById('ap').style.display='none';" href="#exa_tab" aria-controls="exa_tab" role="tab" data-toggle="tab">Examination</a>
							</li>
							<li role="presentation"><a onclick="document.getElementById('se').style.display='none';document.getElementById('surg').style.display='none';document.getElementById('pres').style.display='none';document.getElementById('diag').style.display='none';document.getElementById('pres3').style.display='none';document.getElementById('pres4').style.display='none';document.getElementById('comp').style.display='none';document.getElementById('med_hist').style.display='none';document.getElementById('soc_hist').style.display='block';document.getElementById('vit').style.display='none';document.getElementById('exa').style.display='none';document.getElementById('tp').style.display='none';document.getElementById('ap').style.display='none';" href="#soc_hist_tab" aria-controls="soc_hist_tab" role="tab" data-toggle="tab">Social History</a>
							</li>
							<li role="presentation"><a onclick="document.getElementById('se').style.display='none';document.getElementById('surg').style.display='none';document.getElementById('pres').style.display='none';document.getElementById('diag').style.display='none';document.getElementById('pres3').style.display='none';document.getElementById('pres4').style.display='none';document.getElementById('comp').style.display='none';document.getElementById('med_hist').style.display='block';document.getElementById('soc_hist').style.display='none';document.getElementById('vit').style.display='none';document.getElementById('exa').style.display='none';document.getElementById('tp').style.display='none';document.getElementById('ap').style.display='none';" href="#med_hist_tab" aria-controls="med_hist_tab" role="tab" data-toggle="tab">Medical History</a>
							</li>
						...
						<div class="tab-content">
								...
								<div class="container">
									<div class="row">
												...
												<div class="container" style="margin-left: -15px">
													<div class="row">
														...
														<div class="col-xs-2">
															...
															<input type="text" placeholder="bd" name="pp5x" id="pp5x" value="yyyy-mm-dd" class="date form-control" style="margin-bottom: 20px" disabled>
														</div>
													</div>
												</div>
												<div class="container" style="margin-left: -15px">
													<div class="row">
														...
														<div class="col-xs-2">
															...
															<input type="text" placeholder="SSN" name="ppsn" id="ppsn" class=" form-control" style="margin-bottom: 20px" disabled>
														</div>
													</div>
												</div>
												<div class="container" style="margin-left: -15px">
										...
										<div class="col-xs-4">
											...
											<label for="date"><b>date</b></label>
											<input type="text" placeholder="date" value="yyyy-mm-dd" name="Edate" id="Edate" class=" date form-control" style="margin-bottom: 20px" disabled>
											<label for="start"><b>start</b></label>
											<input type="time" placeholder="start" name="Estart" id="Estart" class="form-control" style="margin-bottom: 20px" disabled>
											<div style="display: none">
												<label for="end"><b>end</b></label>
							...
							<div role="tabpanel" class="tab-pane" id="comp_tab">
								<div class="container">
									<div class="row">
										<div class="col-xs-4">
											<label for="tComplaint"><b>Complaint</b></label>
											<textarea placeholder="Complaint" name="tComplaint" id="tComplaint" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tFrequency"><b>Frequency</b></label>
											<input type="text" placeholder="Frequency" name="tFrequency" id="tFrequency" class="form-control" style="margin-bottom: 20px">
											<label for="tDuration"><b>Duration</b></label>
											<input type="text" placeholder="Duration" name="tDuration" id="tDuration" class="form-control" style="margin-bottom: 20px">
										</div>
										<div class="col-xs-5">
											<table id="dtcomp" class="display" style="width:100%">
												<thead>
													<tr>
														<th>Date</th>
														<th>Complaint</th>
							...
							<div role="tabpanel" class="tab-pane" id="vit_tab">
								<div class="container">
									<div class="row">
										<div class="col-xs-9">
											<table id="dtvit" class="display" style="width:100%">
												<thead>
													<tr>
														<th>Date</th>
														<th>Temp</th>
									...
									<div class="row">
										<div class="col-xs-4">
											<label for="tTemp"><b>Temp</b></label>
											<input type="text" placeholder="Temp" name="tTemp" id="tTemp" class="form-control" style="margin-bottom: 20px">
											<label for="tGCS"><b>GCS</b></label>
											<input type="text" placeholder="GCS" name="tGCS" id="tGCS" class="form-control" style="margin-bottom: 20px">
											<label for="tPulse"><b>Pulse</b></label>
											<input type="text" placeholder="Pulse" name="tPulse" id="tPulse" class="form-control" style="margin-bottom: 20px">
										</div>
										<div class="col-xs-5">
											<label for="tResp"><b>Resp</b></label>
											<input type="text" placeholder="Resp" name="tResp" id="tResp" class="form-control" style="margin-bottom: 20px">
											<label for="tBPS"><b>BP sys</b></label>
											<input type="text" placeholder="BP sys" name="tBPS" id="tBPS" class="form-control" style="margin-bottom: 20px">
											<label for="tBPD"><b>BP dia</b></label>
											<input type="text" placeholder="BP dia" name="tBPD" id="tBPD" class="form-control" style="margin-bottom: 20px">
							...
							<div role="tabpanel" class="tab-pane" id="tp_tab">
								<div class="container">
									<div class="row">
										<div class="col-xs-9">
											<table id="dttp" class="display" style="width:100%">
												<thead>
													<tr>
														<th>Date</th>
														<th>Treatment Plan</th>
														<th>Follow up Advices</th>
													</tr>
												</thead>
												<tfoot>
													<tr>
									...
									<div class="row">
										<div class="col-xs-4">
											<label for="tTP"><b>Treatment Plan</b></label>
											<textarea placeholder="Treatment Plan" name="tTP" id="tTP" class="form-control" style="margin-bottom: 20px"></textarea>
										</div>
										<div class="col-xs-5">
											<label for="tFUA"><b>Follow up Advices</b></label>
											<textarea placeholder="Follow up Advices" name="tFUA" id="tFUA" class="form-control" style="margin-bottom: 20px"></textarea>
							...
							<div role="tabpanel" class="tab-pane" id="exa_tab">
								<div class="container">
									<div class="row">
										<div class="col-xs-9">
											<table id="dtexa" class="display" style="width:100%">
												<thead>
													<tr>
														<th>Date</th>
														<th>Dental</th>
									...
									<div class="row">
										<div class="col-xs-4">
											<label for="tDental"><b>Dental</b></label>
											<textarea placeholder="Dental" name="tDental" id="tDental" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tIntra"><b>Intra Oral</b></label>
											<textarea placeholder="Intra" name="tIntra" id="tIntra" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tExtra"><b>Extra Oral</b></label>
											<textarea placeholder="Extra" name="tExtra" id="tExtra" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tFindings"><b>Findings</b></label>
											<textarea placeholder="Findings" name="tFindings" id="tFindings" class="form-control" style="margin-bottom: 20px"></textarea>
										</div>
										<div class="col-xs-5">
											<label for="tProcedures"><b>Procedures</b></label>
											<textarea placeholder="Procedures" name="tProcedures" id="tProcedures" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tOMFS"><b>OMFS</b></label>
											<textarea placeholder="OMFS" name="tOMFS" id="tOMFS" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tOrthodontic"><b>Orthodontic</b></label>
											<textarea placeholder="Orthodontic" name="tOrthodontic" id="tOrthodontic" class="form-control" style="margin-bottom: 20px"></textarea>
							...
							<div role="tabpanel" class="tab-pane" id="soc_hist_tab">
								<div class="container">
									<div class="row">
										<div class="col-xs-4">
											<label for="tFamily"><b>Family</b></label>
											<textarea placeholder="Family" name="tFamily" id="tFamily" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tStatus"><b>Status</b></label>
											<textarea placeholder="Status" name="tStatus" id="tStatus" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tTravel"><b>Travel</b></label>
											<textarea placeholder="Travel" name="tTravel" id="tTravel" class="form-control" style="margin-bottom: 20px"></textarea>
										</div>
										<div class="col-xs-5">
											<table id="dtsoc_hist" class="display" style="width:100%">
												<thead>
													<tr>
														<th>Date</th>
														<th>Family</th>
							...
							<div role="tabpanel" class="tab-pane" id="med_hist_tab">
								<div class="container">
									<div class="row">
										<div class="col-xs-4">
											<label for="tMedication"><b>Medication</b></label>
											<textarea placeholder="Medication" name="tMedication" id="tMedication" class="form-control" style="margin-bottom: 20px"></textarea>
											<label for="tAllergies"><b>Allergies</b></label>
											<textarea placeholder="Allergies" name="tAllergies" id="tAllergies" class="form-control" style="margin-bottom: 20px"></textarea>
										</div>
										<div class="col-xs-5">
											<table id="dtmed_hist" class="display" style="width:100%">
												<thead>
													<tr>
														<th>Date</th>
														<th>Medication</th>
								...
								<div class="container">
									<div class="row">
										<div class="col-xs-4">
											...
											<input type="text" list="diadia" placeholder="diagnosis" name="dia" id="dia" class="form-control diagn" style="margin-bottom: 20px">
											<datalist id="diadia">
											</datalist>
												...
												<div class="file">
													<div class="line_page_border">
														...
														<div>Patient name: <span id="sl1"></span></br>
															...
															and <span id="slsex1">he</span> was found suffering from <span id="sl3"></span>,
				...
				<div class="modal-footer" id="comp" style="display:none">
					<button type="button" class="btn btn-primary save" onclick="addComp()">Save Complaint</button>
				</div>
				<div class="modal-footer" id="vit" style="display:none">
					<button type="button" class="btn btn-primary save" onclick="addVit()">Save Vital Signs</button>
				</div>
				<div class="modal-footer" id="tp" style="display:none">
					<button type="button" class="btn btn-primary save" onclick="addTP()">Save Treatment Plan</button>
				</div>
				<div class="modal-footer" id="exa" style="display:none">
					<button type="button" class="btn btn-primary save" onclick="addExa()">Save Examination</button>
				</div>
				<div class="modal-footer" id="soc_hist" style="display:none">
					<button type="button" class="btn btn-primary save" onclick="addSocHist()">Save Social History</button>
				</div>
				<div class="modal-footer" id="med_hist" style="display:none">
					<button type="button" class="btn btn-primary save" onclick="addMedHist()">Save Medical History</button>
				</div>
				...
				<div class="modal-footer" id="pres" style="display:none">
					...
					<button type="button" class="btn btn-primary save" onclick="loadPres(); printJS({printable:'prpes', type:'html', css:'css/print_page.css'})">Print prescription</button>
				</div>
				...
				<div class="modal-footer" id="ap" style="display:none">
					<button type="button" class="btn btn-default save" onclick="clearsl()">Clear</button>
				...
				<div class="modal-footer" id="pres4" style="display:none">
					<button type="button" class="btn btn-primary save" onclick="printJS({printable:'viz4', type:'html', css:'css/print_page.css'})">Print</button>
	...
	<div style="display: none" id="payrephead">
		...
		" + "</br>
		<table id="payrep" class="table table-bordered">
			<thead>
				<tr>
					<th>item</th>
					<th>price</th>
	...
	<script>
		...
		$(document).ready(function() {
			...
			tcomp = $('#dtcomp').DataTable({
				"lengthChange": false,
				"bInfo": false,

				"iDisplayLength": 5
			});
			tvit = $('#dtvit').DataTable({
				"lengthChange": false,
				"bInfo": false,
			...
			texa = $('#dtexa').DataTable({
				"lengthChange": false,
				"bInfo": false,

				"iDisplayLength": 5
			});
			tsoc_hist = $('#dtsoc_hist').DataTable({
				"lengthChange": false,
				"bInfo": false,
			...
			tmed_hist = $('#dtmed_hist').DataTable({
				"lengthChange": false,
				"bInfo": false,
		...
		function payrep() {
			var xx = "";
			xx = (`            <caption>Payment report</caption> 
			<thead>
			<tr>
			<th>item</th>
			<th>price</th> 
			...
			xx += (`<tr><td>Entry fees</td><td>` + $('#ent').val() + `</td></tr><tbody>`);

			t6.rows().every(function(rowIdx, tableLoop, rowLoop) {
				var data = this.data();
				xx += ("<tr><td>" + data[1] + " @ tooth: " + data[0] + "</td> <td>" + data[2] + "</td></tr>");
			});
			$("#payrep").last().html("");
			$("#payrep").last().append(xx + "</tbody>");
			printJS('payrep', 'html');
		}

		function loadPres() {
			$("#prpes").html("");
			var xx = "<h4 style='margin-top: 10px'>Alkamil dental clinic </h4></br><h4 style='margin-top: -15px'>C.R no. :1268338</h4></br><h4>prescription: </h4>" + "</br>";
			xx += (`
			...
			t7.rows().every(function(rowIdx, tableLoop, rowLoop) {
				var data = this.data();
				xx += ('<tr>');
				xx += ("<td>" + data[0] + "</td><td>" + data[1] + "</td><td> " + data[2] + "</td>");
				xx += ('</tr>');
		...
		function loadReport() {
			...
			$("#manr").html("");
			$("#prer").html("");
			$("#visr").append("<h4><u>Patient data:</u> </h4>");
			...
			$("#visr").append("SSN: " + " " + $('#ppsn').val() + "</br>");

			$("#visr").append("</br>" + "<h4><u>Visit date:</u> </h4>");
			$("#visr").append($('#Edate').val() + " " + $('#Estart').val() + "</br>");

			$("#diar").append("</br>" + "<h4><u>Diagnosis:</u> </h4>");
			t5.rows().every(function(rowIdx, tableLoop, rowLoop) {
				var data = this.data();
				$("#diar").append(data[1] + " at tooth: " + data[0] + "</br>");
			});
			$("#manr").append("</br>" + "<h4><u>Management:</u> </h4>");
			t6.rows().every(function(rowIdx, tableLoop, rowLoop) {
				var data = this.data();
				$("#manr").append(data[1] + " at tooth: " + data[0] + "</br>");
			});
			$("#prer").append("</br>" + "<h4><u>Prescription:</u> </h4>");
			t7.rows().every(function(rowIdx, tableLoop, rowLoop) {
				var data = this.data();
		...
		function addComp() {
			var t = $('#tComplaint').val();
			var d = $('#tFrequency').val();
			var c = $('#tDuration').val();
			if (t == "" && d == "" && c == "") return;
		...
		function addExa() {
			...
			var d = $('#tIntra').val();
			var c = $('#tExtra').val();
			var t22 = $('#tFindings').val();
			var d22 = $('#tProcedures').val();
			var c22 = $('#tOMFS').val();
			var c2233 = $('#tOrthodontic').val();
			if (t == "" && d == "" && c == "" && t22 == "" && d22 == "" && c22 == "" && c2233 == "") return;
		...
		function addMedHist() {
			var t = $('#tMedication').val();
			var d = $('#tAllergies').val();
			if (t == "" && d == "") return;
