...
<body>
    ...
    <div id="stats" style="display: none">
        <div class="container">
            ...
            <div class="row p-32">
                <h3>Visists Gender/Nationality Report...</h3>
                <div class="container">
                    <div class="row">
                        <div class="col-md-5">
                            <label for="start"><b>start</b></label>
                            <input type="date" placeholder="start" name="start" id="visits_start" class="w-25 form-control" style="margin-bottom: 20px" onchange="loadVisitStats()">
                        </div>
                        <div class="col-md-5">
                            <label for="end"><b>end</b></label>
                            <input type="date" placeholder="end" name="end" id="visits_end" class="w-25 form-control" style="margin-bottom: 20px" onchange="loadVisitStats()">
                        </div>
                        <div class="col-md-2" style="margin-top:24px">
                            <button type="button" class="btn btn-primary save" onclick="printJS('visits','html')">Print</button>
                        </div>
                    </div>
                </div>
                <table id="visits" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <th>Criteria</th>
                            <th>Value</th>
